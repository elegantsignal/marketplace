		...
		<ul class="navbar-nav">
			<sec:authorize access="isAuthenticated()">
				<li class="nav-item dropdown float-right">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
						<a class="dropdown-item" href="${pagesUserCart}">
							<spring:message code="header.menu.shoppingCart"/>
						</a>
						<a class="dropdown-item" href="${pagesUserShop}">
							<spring:message code="header.menu.myShop"/>
						</a>
			...
			<sec:authorize access="!isAuthenticated()">
				<li class="nav-item"><a class="nav-link" href="${login}">
					<spring:message code="header.menu.login"/>
				</a></li>
			</sec:authorize>
